...
class EnglishLetter{final String letter,lowercase,sound,word,emoji;const EnglishLetter(this.letter,this.lowercase,this.sound,this.word,this.emoji);}
const englishLetters=[
EnglishLetter('A','a','a','Apple','🍎'),EnglishLetter('B','b','buh','Ball','⚽'),EnglishLetter('C','c','kuh','Cat','🐱'),EnglishLetter('D','d','duh','Dog','🐶'),
EnglishLetter('E','e','eh','Egg','🥚'),EnglishLetter('F','f','fff','Fish','🐟'),EnglishLetter('G','g','guh','Goat','🐐'),EnglishLetter('H','h','huh','Hat','🧢'),
EnglishLetter('I','i','ih','Ice','🧊'),EnglishLetter('J','j','juh','Juice','🧃'),EnglishLetter('K','k','kuh','Key','🔑'),EnglishLetter('L','l','lll','Lion','🦁'),
EnglishLetter('M','m','mmm','Moon','🌙'),EnglishLetter('N','n','nnn','Nose','👃'),EnglishLetter('O','o','oh','Orange','🍊'),EnglishLetter('P','p','puh','Pen','🖊️'),
EnglishLetter('Q','q','kwuh','Queen','👑'),EnglishLetter('R','r','ruh','Rabbit','🐰'),EnglishLetter('S','s','sss','Sun','☀️'),EnglishLetter('T','t','tuh','Tree','🌳'),
EnglishLetter('U','u','uh','Umbrella','☂️'),EnglishLetter('V','v','vvv','Van','🚐'),EnglishLetter('W','w','wuh','Water','💧'),EnglishLetter('X','x','ks','X-ray','🩻'),
EnglishLetter('Y','y','yuh','Yellow','🟡'),EnglishLetter('Z','z','zzz','Zoo','🦓')];
