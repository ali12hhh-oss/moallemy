...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _parentCard() => _PressCard(
    ...
    child: const ListTile(
      ...
      title: Text('متابعة الأسرة', style: TextStyle(fontSize: 21, fontWeight: FontWeight.w900)),
      subtitle: Text('نتائج الطفل، المهارات المتقنة، ما يحتاج إلى مراجعة والإنجازات'),
