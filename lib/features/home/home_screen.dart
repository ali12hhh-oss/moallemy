      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            MenuCard(title:'اللغة العربية — المنهج الكامل',subtitle:'الصوتيات والقراءة والقواعد والكتابة',emoji:'📚',image:'assets/images/letters.png',onTap:()=>open(c,const ArabicCurriculumScreenV16(grade:3))),
            MenuCard(title:'الرياضيات — المنهج الكامل',subtitle:'مهارات حقيقية وتدريبات وألعاب',emoji:'🧮',image:'assets/images/numbers_v6.png',onTap:()=>open(c,const MathCurriculumScreenV15(grade:3))),
            MenuCard(title:'رياضيات ومهارات الحساب',subtitle:'جمع وطرح وقيمة مكانية وأنماط ومسائل',emoji:'🔢',image:'assets/images/numbers_v6.png',onTap:()=>open(c,const MathCurriculumScreenV14(grade:3))),
            ...
            Card(child:ListTile(leading:const Text('📚',style:TextStyle(fontSize:32)),title:const Text('محتوى المرحلة ١١',style:TextStyle(fontWeight:FontWeight.bold)),subtitle:Text('أكثر من ${arNum(allArabicWordsV11.length)} كلمة عربية • ${arNum(englishWordsV11.length)} كلمة English • ${arNum(storiesV11.length)} قصص موسعة • ${arNum(gamesV11.length)} ألعاب'),)),
