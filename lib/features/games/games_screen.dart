...
class _S extends State<GamesScreen>{final r=Random();int mode=0,score=0;late ArabicLetter target;List<ArabicLetter> options=[];List<WordV11> match=[];int numberTarget=0;List<int> numberOptions=[];
