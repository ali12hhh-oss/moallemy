...
class _S extends State<SentenceScreen>{int i=0;@override Widget build(BuildContext c){final s=arabicSentences[i];return Directionality(textDirection:TextDirection.rtl,child:Scaffold(appBar:AppBar(title:const Text('القراءة والفهم')),body:Padding(padding:const EdgeInsets.all(20),child:Column(children:[
