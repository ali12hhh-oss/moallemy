    ...
    return Directionality(textDirection:TextDirection.rtl,child:Scaffold(
      ...
      body:ListView(padding:const EdgeInsets.all(16),children:[
        Card(child:Padding(padding:const EdgeInsets.all(16),child:Text(
          'مسار رياضيات متدرج: ${skills.length} مهارات تعليمية مع حفظ الإتقان Offline.',
          style:const TextStyle(fontSize:18),
        ))),
        ...skills.map((s)=>FutureBuilder<int>(
          future:MathSkillsEngineV14.mastery(s.id),
          builder:(c,snap){
            final m=snap.data??0;
            return Card(child:ListTile(
              ...
              onTap:()=>Navigator.push(context,MaterialPageRoute(builder:(_)=>MathPracticeV14(skill:s))),
            ));
          },
        )),
      ],
