      ...
      child: Scaffold(
        ...
        body: FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            final accuracy = child?.accuracy ?? 0;
            final lessons = child?.lessons ?? 0;
            return ListView(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('الدروس المكتملة: ${arNum(lessons)}'),
                        LinearProgressIndicator(value: (lessons / 20).clamp(0, 1).toDouble()),
                        const SizedBox(height: 14),
                        Text('دقة الاختبارات: ${arNum((accuracy * 100).round())}٪'),
                        LinearProgressIndicator(value: accuracy.toDouble()),
                        const SizedBox(height: 14),
