      ...
      body: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            title: const Text('Phonics Letters'),
            subtitle: const Text('Letter sounds, not letter names'),
            onTap: () => open(context, const EnglishLettersScreen()),
          ),
          ListTile(
            leading: const Text('🧩', style: TextStyle(fontSize: 35)),
            title: const Text('Simple Words'),
            onTap: () => open(context, const EnglishWordsScreen()),
          ),
          ListTile(
            leading: const Text('🔤', style: TextStyle(fontSize: 35)),
            title: const Text('Phonics Rules'),
            subtitle: const Text('sh, ch, th, ph, oo, ee and more'),
              ...
              child: InkWell(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(w.word, style: const TextStyle(fontSize: 21, fontWeight: FontWeight.bold)),
                    Text('sound: ${w.sound}'),
        ...
        children: [
          for (final x in englishColors)
            ListTile(
              ...
              title: Text(x['name']!, style: const TextStyle(fontSize: 22)),
              subtitle: Text(x['ar']!),
              trailing: IconButton(
