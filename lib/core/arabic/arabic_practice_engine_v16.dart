...
class ArabicPracticeEngineV16 {
  ...
  static ArabicQuestionV16 harakat(String id) {
    ...
    final options = _shuffle([answer, 'بَ', 'بِ', 'بُ'].toSet().toList());
  ...
  static ArabicQuestionV16 tanween(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], 'فتح', 'ضم', 'كسر'].toSet().toList()),
  ...
  static ArabicQuestionV16 longVowels(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], 'الألف', 'الواو', 'الياء'].toSet().toList()),
  ...
  static ArabicQuestionV16 syllables(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], 'ذَهَبَ', 'لَعِبَ', 'رَسَمَ'].toSet().toList()),
  ...
  static ArabicQuestionV16 sunMoon(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], 'شمسية', 'قمرية'].toSet().toList()),
  ...
  static ArabicQuestionV16 preposition(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], 'إلى', 'في', 'على', 'من'].toSet().toList()),
  ...
  static ArabicQuestionV16 alDefinition(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], x[0], 'كتابان', 'كتب'].toSet().toList()),
  ...
  static ArabicQuestionV16 singularPlural(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], 'كتاب', 'قلم', 'ولد'].toSet().toList()),
  ...
  static ArabicQuestionV16 masculineFeminine(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], 'مذكر', 'مؤنث'].toSet().toList()),
  ...
  static ArabicQuestionV16 spelling(String id) {
    const items = [
      ['مَدْرَسَة', ['مَدْرَسَة', 'مَذْرَسَة', 'مَدْرَسَه']],
      ['شَجَرَة', ['شَجَرَة', 'شَجَرَه', 'شَجَرَت']],
      ['قَلَم', ['قَلَم', 'قَلَن', 'كَلَم']],
      ['سَمَكَة', ['سَمَكَة', 'سَمَكَه', 'ثَمَكَة']],
    ];
    final x = items[_random.nextInt(items.length)];
    return ArabicQuestionV16(
      skillId: id,
      ...
      answer: x[1][0],
      options: _shuffle(x[1]),
      explanation: 'الكتابة الصحيحة هي: ${x[1][0]}.',
    );
  }
  ...
  static ArabicQuestionV16 wordAnalysis(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], '٢', '٤', '٥', '٦', '٧'].toSet().toList()),
  ...
  static ArabicQuestionV16 sentenceType(String id) {
    ...
    return ArabicQuestionV16(
      ...
      answer: x[1],
      options: _shuffle([x[1], 'اسمية', 'فعلية'].toSet().toList()),
